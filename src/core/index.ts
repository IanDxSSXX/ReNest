...
import {Prop, DotProp, Context, Callback, Contexts, Hook, SHook, Observe} from "./element/Decorator";
...
export {Prop, DotProp, Context, Contexts, Callback, State, Ref, Spring, Theme, Navigate, Hook, SHook, Observe}  // decorators
